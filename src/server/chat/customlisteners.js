const createListeners = require('./defaultlisteners')
const {dehash, capitalize, submitchat, getChunks} = require('./chatfunctions')
const {getBitImage} = require('./user')
const {checkAvatar, checkfollowers, checkstreamer} = require('./chatapi')
const {followerhook, streaminghook} = require('../webhooks')
const {parseMessage} = require('./chatbackend')
...
//subscription
  ...
  // listener.notice = function(channel, msgid, message) {
  /*
  ...
  */
  ...
  listener.cheer = function (channel, userstate, message) {
  ...
  listener.connected = async function (address, port) {
  ...
  listener.join = async function (channel, username) {
    ...
    listener.message = async function (channel, user, message, self) {
  ...
  listener.subscription = function (channel, username, method, message, userstate) {
  ...
  createListeners(Twitch, listener)
}